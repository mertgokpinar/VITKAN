...
import os
import pdb
from core.wsi_core.util_classes import Mosaic_Canvas
...
def StitchCoords(hdf5_file_path, wsi_object, downscale=16, draw_grid=False, bg_color=(255,255,255), alpha=1):
